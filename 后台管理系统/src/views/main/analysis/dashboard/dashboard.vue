    ...
    <div class="body">
      <div class="up">
        <el-row :gutter="13">
          ...
          ></el-col>
          <el-col :span="8"
            ><echart> <mapChart :map-data="showAddress"></mapChart> </echart
          ></el-col>
          <el-col :span="8"
            ><echart> <roseChart :roseData="showSale"></roseChart> </echart
          ></el-col>
        </el-row>
      </div>
      <div class="middle">
        <el-row :gutter="13">
          <el-col :span="12"
            ><echart> <barChart v-bind="showFavor"></barChart> </echart
          ></el-col>
          <el-col :span="12"
            ><echart> <lineChart v-bind="showSale2"></lineChart> </echart
          ></el-col>
        </el-row>
      </div>
    </div>
